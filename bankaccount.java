...
    }
    ...
    Part 1: User Interface and bank account setup
This exercise is part 1 of 3 parts in the Bank Account project. This is a summary of what you will do in each part of the project.

Part 1: Setup the user interface and the bank accounts 
...
T​he logic for the code to manage bank accounts

This is an example of the output produced from your fully completed part one code:

Example of the opening screen. Welcome to your banking system. What kind of account would you like to create?
 Scenario
In this project, you are creating a simulation of an online bank account system. The system will support 3 different bank account types.  The bank account type can be a Debit Account, a Credit Account or a Checking Account. You will use print statements to create the visual interface and then use loops and when statements to process the simulated user input and implement the bank account app’s operations.

Instructions
Use the Kotlin playground to complete this exercise. In the Playground, remember that you can erase just the content between the opening brace { and closing brace } of the main function and place your code there. Refer to the Welcome to Kotlin Playgrounds reading in Week 1 to refresh your memory on creating and launching a new Kotlin Playground.  

Once you have created a new playground, follow the steps below to begin creating your banking system app.

Tip: Use a while loop to create the bank account based on the user’s choice. Refer to the While statement reading in Week 1.

Tip: Use when expressions to select the right bank account type from the list of bank account types provided by the bank app user interface.  Refer to the More on the When statement reading in Week 1.
...
Tip: Refer to the Practice creating Loops reading in Week 1 to refresh your memory on using while loops.
...
Tip: Refer to the When statements reading in Week 1.
...
Run your program and write down the output you observe from the two cases below. 
 ...
 Concluding thoughts
In this exercise, you worked with loops and when expressions to create your bank account and process user input from the console. 

In part 2 of this project, you will progress your code to define the bank account’s operations. Finally, in part 3, you will manage the bank account.
